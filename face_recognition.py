...
class Face_Recognition:
    def __init__(self,root):
        ...
        #Button
        b1=Button(f_lb2,text="Face Recognition",cursor="hand2",command=self.face_recog,font=("times new roman",16,"bold"),bg="CRIMSON",fg="AQUA")
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for(x,y,w,h) in features:
                ...
                if confidence>77:
                    cv2.putText(img,f"roll_no:{r}",(x,y-55),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),2)
        ...
        def recognize(img,clf,facecascade):
            coord=draw_boundray(img,facecascade,1.1,10,(0,25,0),"Face",clf)  
            return img
